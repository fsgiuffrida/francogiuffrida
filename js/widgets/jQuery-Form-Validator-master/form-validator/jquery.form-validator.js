...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    LANG: {
		...
		badUKVatAnswer:"No n&uacute;mero VAT proporcionado no es v&aacute;lido para el Reino Unido",
		badStrength:"La contrase&ntilde;a proporcionada no es lo suficientemente segura",
		badNumberOfSelectedOptionsStart:"Debe seleccionar al menos",
		badNumberOfSelectedOptionsEnd:" respuesta(s)",
		badAlphaNumeric:"El valor proporcionado solo debe contener caracteres alfanum&eacute;ricos (a-z y n&uacute;meros)",
		badAlphaNumericExtra:" y",
		wrongFileSize:"El archivo que est&aacute; tratando de subir es demasiado grande (m&aacute;x. %s)",
		wrongFileType:"S&oacute;lo los archivos del tipo %s est&aacute;n permitido",
		...
		imageTooSmall:"la imagen es demasiado peque&ntilde;a",
		min:"min.",
		max:"m&aacute;x.",
